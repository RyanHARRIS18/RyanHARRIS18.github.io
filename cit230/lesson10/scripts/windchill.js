  ...
  .then(
    (currentWeather)=>{
      ...
      let windSpeed = parseInt(document.getElementById("Forecast5").innerHTML);
       ...
       //local forecast
       document.getElementById("Forecast1").textContent = "Current Temperature: " + currentWeather.main.temp + "°";
       document.getElementById("Forecast2").textContent = "High: " + currentWeather.main.temp_max + '°';
       document.getElementById("Forecast4").textContent = "Wind Chill: " + currentWeather.main.humidity + '°';
